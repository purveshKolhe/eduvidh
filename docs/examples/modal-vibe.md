...
Source: https://modal.com/docs/examples/modal-vibe
...
* `sandbox` contains a small HTTP server that gets put inside every Sandbox thatâs created, as well as some sandbox lifecycle management code.
...
[Modal Vibe: A scalable AI coding platform](#modal-vibe-a-scalable-ai-coding-platform)[How itâs structured](#how-its-structured)[How to run](#how-to-run)[Deploy](#deploy)[Local Development](#local-development)
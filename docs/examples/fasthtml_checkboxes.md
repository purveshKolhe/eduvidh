...
Source: https://modal.com/docs/examples/fasthtml_checkboxes
...
[![Screenshot of FastHTML Checkboxes UI](/_app/immutable/assets/ui.BaSTrcQW.png)](https://modal-labs-examples--example-fasthtml-checkboxes-web.modal.run)

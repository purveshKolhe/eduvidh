...
Source: https://modal.com/docs/examples/cron_datasette
...
Letâs get started writing code.
...
## Persistent dataset storageÂ

To separate database creation and maintenance from serving, weâll need the underlying
database file to be stored persistently. To achieve this we use a [Volume](https://modal.com/docs/guide/volumes).
...
First, letâs define a metadata object for the database.
...
When publishing the interactive Datasette app youâll want to create a persistent URL.

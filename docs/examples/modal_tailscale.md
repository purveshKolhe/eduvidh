...
Source: https://modal.com/docs/examples/modal_tailscale
...
be able to see Modal containers in your Tailscale dashboard in the âMachinesâ tab.
Every new container launched will show up as a new âmachineâ. Containers are

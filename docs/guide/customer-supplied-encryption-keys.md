...
Source: https://modal.com/docs/guide/customer-supplied-encryption-keys
...
you capture a directory from a running Sandbox as an [Image](/docs/sdk/py/latest/modal.Image). With CSEK, you pass key material when
creating the snapshot and pass the same key again when mounting it.

### Create a CSEK-protected directory snapshotÂ
...
### Mount a CSEK-protected directory snapshotÂ
...
### Re-snapshotting encrypted directoriesÂ
...
retained for 30 days after creation. See [Snapshot Retention](/docs/guide/sandbox-snapshots#snapshot-retention) for details.

[Customer Supplied Encryption Keys](#customer-supplied-encryption-keys)[How CSEK works](#how-csek-works)[Supported resources](#supported-resources)[Directory Snapshots](#directory-snapshots)[Create a CSEK-protected directory snapshot](#create-a-csek-protected-directory-snapshot)[Mount a CSEK-protected directory snapshot](#mount-a-csek-protected-directory-snapshot)[Re-snapshotting encrypted directories](#re-snapshotting-encrypted-directories)[Retention](#retention)
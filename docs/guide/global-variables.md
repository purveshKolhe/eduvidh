...
Source: https://modal.com/docs/guide/global-variables
...
* You need to use the data in a scheduled function (scheduled functions donât
  accept arguments)
* You need to construct objects (e.g. Secrets) in global scope to use as
  function annotations
* You donât want to clutter many function signatures with some common arguments
...
## Warning about regular module globalsÂ

...
## Deploy Secrets from the Modal DashboardÂ

The most common way to create a Modal Secret is to use the [Secrets panel of the Modal dashboard](/secrets),
which also shows any existing Secrets.

When you create a new Secret, youâll be prompted with a number of templates to help you get started.
...
## Use Secrets in your Modal AppsÂ
...
## Create Secrets programmaticallyÂ
...
## Interact with Secrets from the command lineÂ

...
Source: https://modal.com/docs/guide/webhook-proxy-auth
...
Proxy authorization can be added to [Web Functions](/docs/guide/webhooks) created by the [`fastapi_endpoint`](/docs/sdk/py/latest/modal.fastapi_endpoint), [`asgi_app`](/docs/sdk/py/latest/modal.asgi_app), [`wsgi_app`](/docs/sdk/py/latest/modal.wsgi_app), or [`web_server`](/docs/sdk/py/latest/modal.web_server) decorators,
which are otherwise publicly available.

Everyone within the Workspace of the Web Function can manage its Proxy Tokens.

## Restricting tokens to specific EnvironmentsÂ
...
[Proxy Tokens](#proxy-tokens)[Restricting tokens to specific Environments](#restricting-tokens-to-specific-environments)

See it in action

[Create a Proxy Token](/settings/proxy-auth-tokens)

...
Source: https://modal.com/docs/guide/parameterized-functions
...
To parametrize a Modal Function, you need to use Modalâs [class syntax](/docs/guide/lifecycle-functions) and the [`@app.cls`](/docs/sdk/py/latest/modal.App#cls) decorator. Specifically, youâll need to:
...
## Looking up a parametrized functionÂ
...
## Using parametrized functions with lifecycle functionsÂ
...
[Parametrized functions](#parametrized-functions)[Looking up a parametrized function](#looking-up-a-parametrized-function)[Parametrized Web Functions](#parametrized-web-functions)[Using parametrized functions with lifecycle functions](#using-parametrized-functions-with-lifecycle-functions)[Performance](#performance)
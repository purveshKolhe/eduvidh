...
Source: https://modal.com/docs/guide/sdk-javascript-go
...
Weâre working towards feature parity with the main Modal Python SDK, although defining Modal Functions will likely remain exclusive to Python.
...
[Modal SDKs for JavaScript and Go](#modal-sdks-for-javascript-and-go)[Installation](#installation)[JavaScript/TypeScript](#javascripttypescript)[Simple JavaScript Example](#simple-javascript-example)[Go](#go)[Simple Go Example](#simple-go-example)[Support](#support)
...
Source: https://modal.com/docs/guide/budgets
...
You can set, edit, or remove Environment budgets on the [Workspace Management â Environments](/settings/workspace-management/environments) page.

[Budgets](#budgets)[When to use each budget](#when-to-use-each-budget)[How limits apply](#how-limits-apply)[Workspace budgets](#workspace-budgets)[Environment budgets](#environment-budgets)
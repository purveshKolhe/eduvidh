...
Source: https://modal.com/docs/guide/dataset-ingestion
...
## Configure your Function for heavy disk usageÂ
...
### Prefer sharded or archived outputs for tiny-file datasetsÂ
...
and benchmark transforms before automating the full ingestion job. [Modal Notebooks](/docs/guide/notebooks) work well for this. Attach the same Volume that your ingestion Functions use, keep transient scratch
...
* Data derived from the [Big âFantasticâ Database](https://bfd.mmseqs.com/), [Protein Data Bank](https://www.wwpdb.org/), and [UniProt Database](https://www.uniprot.org/) used in training the [RoseTTAFold](https://github.com/RosettaCommons/RoseTTAFold) protein structure model

[Large dataset ingestion](#large-dataset-ingestion)[Configure your Function for heavy disk usage](#configure-your-function-for-heavy-disk-usage)[Prefer sharded or archived outputs for tiny-file datasets](#prefer-sharded-or-archived-outputs-for-tiny-file-datasets)[Experimentation](#experimentation)[Downloading](#downloading)[Transforming](#transforming)[Examples](#examples)

See it in action

[Work interactively in Modal Notebooks](/docs/guide/notebooks)

[Store datasets on Volumes](/docs/guide/volumes)
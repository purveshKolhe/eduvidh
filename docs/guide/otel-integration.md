...
Source: https://modal.com/docs/guide/otel-integration
...
to send messages to our collector in HTTP format. You donât need to do this to get the
...
5. Save your changes and use the test button to confirm that logs are being sent to your provider.
   If itâs all working, you should see a `Hello from Modal! ð` log from the `modal.test_logs` service.
...
[Connecting Modal to your OpenTelemetry Provider](#connecting-modal-to-your-opentelemetry-provider)[What this integration does](#what-this-integration-does)[Metrics](#metrics)[Custom metrics](#custom-metrics)[Installing the integration](#installing-the-integration)[Uninstalling the integration](#uninstalling-the-integration)
...
Source: https://modal.com/docs/guide/sandbox-resources
...
For general documentation on CPU and memory options, see [Reserving CPU and memory](/docs/guide/resources).

## Pay for what you useÂ
...
For details on default values and maximum limits, see [Reserving CPU and memory](/docs/guide/resources).
...
[Sandbox resources and pricing](#sandbox-resources-and-pricing)[Pay for what you use](#pay-for-what-you-use)[Configuring resources](#configuring-resources)[Resource limits](#resource-limits)[Tuning your requests](#tuning-your-requests)[GPU Sandboxes](#gpu-sandboxes)[Additional resources](#additional-resources)

See it in action

[Reserving CPU and memory](/docs/guide/resources)

[Sandboxes overview](/docs/guide/sandboxes)

[Sandbox pricing](/pricing#sandboxes)
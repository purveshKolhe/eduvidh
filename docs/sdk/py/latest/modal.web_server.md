...
Source: https://modal.com/docs/sdk/py/latest/modal.web_server
...
Here, requests to the URL will go to external port 8000 on the container. The `http.server` module is included with Python, but you could run anything here.
